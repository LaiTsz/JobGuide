...
import com.project.job_guide.databinding.FragmentCreateAccountBinding
import com.project.job_guide.ui.main.MainActivity
import com.project.job_guide.util.SharedPreferencesUtil
import com.project.job_guide.util.forceHideKeyboard
import com.project.job_guide.util.showSnackBar
...
class CreateAccountFragment : Fragment() {
    ...
    private fun navigateToHome() {
        findNavController().navigate(R.id.action_createAccountFragment_to_navigation_home)
    }
}